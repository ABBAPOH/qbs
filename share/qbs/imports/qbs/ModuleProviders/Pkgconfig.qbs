...
ModuleProvider {
    ...
    relativeSearchPaths: {
        console.debug("Running pkgconfig provider for module '" + name + "'.");
        ...
        module.writeLine("import qbs.ModuleProviderModules");
        module.writeLine("ModuleProviderModules.Pkgconfig {");
        module.writeLine("    theName: " + ModUtils.toJSLiteral(packageName));
        module.writeLine("}");
        module.close();
        return "";
    }
